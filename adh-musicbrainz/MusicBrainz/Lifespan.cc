...
MusicBrainzADH::CLifespan::CLifespan(const XMLNode& Node)
{
	if (!Node.isEmpty())
	{
...
MusicBrainzADH::CLifespan::CLifespan(const CLifespan& Other)
{
	*this=Other;
}

MusicBrainzADH::CLifespan& MusicBrainzADH::CLifespan::operator =(const CLifespan& Other)
{
	if (this!=&Other)
	{
...
std::string MusicBrainzADH::CLifespan::Begin() const
{
	return m_Begin;
}

std::string MusicBrainzADH::CLifespan::End() const
{
	return m_End;
}
